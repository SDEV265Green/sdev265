...
*/
    ...
    diceRoll() {
        ...
        //show end turn button and hide roll button
        document.querySelector('.end-turn').style.display = 'inline';
...
*/
    ...
    nextTurn() {
        ...
        //hide end turn button and show roll button
...
*/
    ...
    produceResources(roll) {
        ...
        document.querySelector('.end-turn').addEventListener('click', this.nextTurn);
